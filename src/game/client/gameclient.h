...
class CGameClient : public IGameClient
{
	...
	// MClient
	static void BotAimDistance(IConsole::IResult *pResult, void *pUserData);
	static void BotAdminID(IConsole::IResult *pResult, void *pUserData);
...
public:
	...
	bool IsHookTile(int PosX, int PosY);
