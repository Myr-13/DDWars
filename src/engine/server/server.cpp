...
void CServer::SpawnNPC(int id) {
	m_NetServer.DummyInit(id);
	m_aClients[id].m_State = CClient::STATE_INGAME;
	m_aClients[id].m_Authed = AUTHED_NO;

	str_copy(m_aClients[id].m_aName, "Robert", 16);
}
